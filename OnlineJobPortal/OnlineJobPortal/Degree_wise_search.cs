...
{
    public partial class Degree_wise_search : Form
    {
        SqlConnection con;
        SqlCommand cmd;
        SqlDataReader dr;
        public Degree_wise_search()
        {
            InitializeComponent();
        }
        
        private void btn_degree_search_Click(object sender, EventArgs e)
        {
            ...
            String query = "Select * from Companies WHERE d_name = '" +txt_search.Text+"'";
        ...
        private void Degree_wise_search_Load(object sender, EventArgs e)
        {
